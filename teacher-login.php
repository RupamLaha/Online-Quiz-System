    ...
    <div class="container">
      <div class="row content">
        ...
        <div class="col-md-6 mb-3">
            <h2><center>Online Quiz</center></h2><br>
        ...
        <div class="col-md-6">
          <br>
          <center><h4>Teacher Sign In</h4></center>
          <br>
          <form action="teacher_login_sub.php" method="post">
          <?php
          ...
          ?>
            <div class="form-group">
              ...
              <div class="signup">
                <br>
                New to Online Quiz?
                <a href="teacher_signup.php" class="signup-link">Sign Up</a>
              </div>
          </form>
        </div>
      </div>
