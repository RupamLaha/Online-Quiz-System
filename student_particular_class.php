...
<div class="container-fluid" style="margin-top:70px">
  ...
  <ul class="nav nav-tabs">
    ...
    <!-- <li class="nav-item ml-auto">
      <a href="home.php" class="btn btn-danger">Go to Home</a>
    </li> -->
    </ul>
      ...
      <h3>Quizes</h3>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><a href="enter_student_particular_quiz.php?class_id=<?php echo $class_id; ?>&quiz_id=<?php echo $quiz['id']; ?>" class="btn btn-success" role="button">Enter</a></td>
